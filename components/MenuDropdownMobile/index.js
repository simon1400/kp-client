...
const MenuDropdownMobile = ({index, data}) => {
  ...
  return(
    <div 
      id={`dropdown_${index}`} 
      className="menu-dropdown uk-dropdown yellow-top" 
      uk-dropdown="mode: click; offset: 0; pos: bottom; target: .header; animation: slide-right-medium; animate-out: true; duration: 200"
    >
